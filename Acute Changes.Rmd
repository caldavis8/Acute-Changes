...
```
```{r}
View(collection_data$treatment)
```
...
determine which thermocouple was used for the specific lizard. Find that calibration curve for that specific thermocouple and apply it to that lizards thermocouple data
