...
##For the life of me I can't come up with a way to create a line graph where all of the CEWL x time (or temp) lines would start at the same relative Y-intercept like we had initiially planned to to. I have been searching stack overflow for days and can't come up with a way to shift all lines to one relative position!!!!!!!!!!!! 
...
cewl_mml <- lmer(data = subset_cewl,
                 Flux_g.m2h ~ Time_sec + Treatment + Amb_temp_C + Amb_humidity_. + 
                 Cloacal_Temp_C +
                 (1|ï..ID) )
summary(cewl_mml)
```
